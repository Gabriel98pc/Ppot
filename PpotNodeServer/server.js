				    	...
				    	if(result)
				    	{
				    		currentUser = 
						    {
						      ...
						      position: data.position,
								...
								socket.emit("LOGIN_SUCCESS", currentUser.id, currentUser.user, currentUser.position, currentUser.coins, currentUser.password);
						    ...
						    clients.forEach( function(i) 
						    {
								  if(i.id != currentUser.id)
									{ 
								      //send to the client.js script
								    socket.emit('SPAWN_PLAYER',i.id,i.user,i.position);
								...
								socket.broadcast.emit('SPAWN_PLAYER',currentUser.id,currentUser.user,currentUser.position);
				    	}
					  });
				}
				else
